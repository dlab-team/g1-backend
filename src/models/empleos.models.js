...
export const insertEmpleo = async (data) => {
    const { cargo, descripcion, ubicacion, modalidad, salario, nombreEmpresa, creadoEn, listaId, usuarioId } = data
    try {
        ...
        const values = [cargo, descripcion, ubicacion, modalidad, salario, nombreEmpresa, creadoEn, listaId, usuarioId]
       return await data(consulta, values)
    } catch (error) {
        return error
    }
