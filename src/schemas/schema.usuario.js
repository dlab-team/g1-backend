...
export const usuarioSchema = z.object({
  ...
  education: z.enum(['Ingeniero de Sistemas', 'Analista de Sistemas', 'Ingeniero en Computación', 'Ingeniero Informático', 'Desarrollador Backend', 'Desarrollador Frontend', 'Desarrollador Fullstack', 'DevOps', 'Otro'], { message: 'Educación es requerida' }),
  jobTitle: z.enum(['Desarrollador', 'Diseñador', 'Analista', 'Otro'], { message: 'Cargo es requerido' }),
  experience: z.enum(['Trainee', 'Semi-Senior', 'Senior', 'Sin Experiencia', 'Otro'], { message: 'Experiencia es requerida' }),
